 ...
 * - Some furniture models are back-to-front, makes the orientation learning problematic
 */

int main(int argc, char* argv[]) {
    // TODO: remove (relax) the 1/2 area contraint when sampling furniture list
    // TODO: add furniture accessibale space
