...
def main():
    ...
    val_dataset = SegDataset(valdir, transform)
    test_dataset = SegDataset(testdir, transform)
    ...
    test_prec = validate(test_loader, model, criterion)
    print('Testing precision: {:.03f}'.format(test_prec))
